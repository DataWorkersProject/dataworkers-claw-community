...
export const TEMPLATES: PipelineTemplate[] = [
  ...
  // CDC streaming templates (real-time change data capture)
  {
    id: 'cdc-streaming-kafka',
    name: 'CDC Streaming (Kafka)',
    description: 'Kafka-based change data capture pipeline. Captures row-level changes and streams them to a target table with exactly-once semantics.',
    category: 'cdc',
    orchestrator: 'airflow',
    codeLanguage: 'python',
    parameters: [
    ...
    exampleDescription: 'Capture CDC events from PostgreSQL via a Kafka consumer, merge into Iceberg orders table',
    version: '1.0.0',
  ...
  },
  {
    ...
    description: 'Real-time CDC pipeline with integrated stream health monitoring. Includes automatic backpressure handling and dead-letter queue.',
    category: 'cdc',
    orchestrator: 'prefect',
    codeLanguage: 'python',
    parameters: [
    ...
    exampleDescription: 'Real-time CDC from MySQL to Snowflake with stream health monitoring and DLQ',
    version: '1.0.0',
    lastUpdated: '2026-03-01T00:00:00Z',
  },
];
