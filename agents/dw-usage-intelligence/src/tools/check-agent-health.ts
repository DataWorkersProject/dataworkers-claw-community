/**
 * check_agent_health — Per-agent health status (retained from dw-observability).
 *
...
export function classifyHealth(errorRate: number, heartbeatAgeMs: number): HealthStatus {
