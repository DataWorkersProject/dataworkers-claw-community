...
#
# Install:  brew install DataWorkersProject/tap/data-workers
...
class DataWorkers < Formula
  ...
  homepage "https://github.com/DataWorkersProject/dataworkers-claw-community"
  url "https://github.com/DataWorkersProject/dataworkers-claw-community/archive/refs/tags/v#{version}.tar.gz"
  version "0.1.0"
  ...
  def caveats
    <<~EOS
      ...
      Documentation: https://github.com/DataWorkersProject/dataworkers-claw-community
    EOS
  end
