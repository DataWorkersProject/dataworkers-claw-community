...
`homebrew-tap` under the `DhanushAShetty` GitHub account and copy
...
1. Tag a new release on `dw-claw-community` (e.g. `v0.2.0`).
2. Download the tarball and compute the SHA256:
   ```bash
   curl -sL https://github.com/DhanushAShetty/dw-claw-community/archive/refs/tags/v0.2.0.tar.gz | shasum -a 256
   ```
